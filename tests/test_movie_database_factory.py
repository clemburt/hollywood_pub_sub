"""Tests for the movie_database_factory module."""
...
def movie_database_json_path() -> Path:
    """Return path to JSON fixture or skip test if not found."""
...
def test_factory_loads_from_json(movie_database_json_path):
    """Test factory returns MovieDatabaseFromJSON instance when json_path is provided."""
...
def test_factory_loads_from_api(mock_tmdb_get, mock_api_class):
    """Test factory returns MovieDatabaseFromAPI instance when api_key is provided."""
...
def test_factory_json_path_takes_precedence_over_api_key(movie_database_json_path):
    """Test that json_path takes precedence over api_key if both are provided."""
...
def test_factory_raises_without_json_or_api_key():
    """Test that factory raises ValueError if neither json_path nor api_key is provided."""
